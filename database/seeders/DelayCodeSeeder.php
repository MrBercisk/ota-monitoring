...
class DelayCodeSeeder extends Seeder
{
    public function run()
    {
        $codes = [
            ...
            ['code' => 'EC', 'reason' => 'Cargo preparation/documentation',                'category' => 'EDP (Authomated Equipment Failure)'],
            ['code' => 'ED', 'reason' => 'Departure Control',                              'category' => 'EDP (Authomated Equipment Failure)'],
            ['code' => 'EF', 'reason' => 'Flight Plan',                                    'category' => 'EDP (Authomated Equipment Failure)'],
            ['code' => 'EO', 'reason' => 'Other System Failure',                           'category' => 'EDP (Authomated Equipment Failure)'],
        ...
        foreach ($codes as $item) {
            $category = DelayCategory::where('name', $item['category'])->first();

            DelayCode::create([
                'code'              => $item['code'],
                'reason'            => $item['reason'],
                'delay_category_id' => $category?->id,
            ]);
        }
    }
}